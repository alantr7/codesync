            ...
            <tbody>
                ...
                {fileList.map(file => <tr>
                    ...
                    <td>
                        ...
                        {file.preview_mode !== "BINARY" && file.preview_mode !== "DOCUMENT" && <a href={`${HOST}/api/projects/${ownerId}/${projectId}/files/${file.id}/view?token=${file.access_token}`} target="_blank">{file.name}</a>}
